      ...
      <Grid.Container gap={2}>
        ...
        >
          <Text>
            ...
            is the perfect solution to quickly create a winning cover letter
            that will help you stand out and land your dream job. With one
            simple click, ResumeRocket will generate a personalized and
            professional cover letter that is tailored to your unique job
            ...
            >
              <Card.Body css={{ py: "$10" }}>
                <Text>
                  ...
                  <br />
                  <br />
                  Throughout my academic career, I have developed a diverse set
                  of skills through technical courses such as Applied
                  Statistics, Computer Systems, Data Structures, Data Systems,
                  Software Engineering, Computer Networking, Algorithm Analysis
                  and Design, Operating Systems, Artificial Intelligence, and
                  Advanced Algorithms. I am proficient in programming languages
                  such as Python, C, C++, Git, LATEX, PyTorch, TensorFlow,
                  Pandas, Matplotlib, and NumPy. Additionally, I am fluent in
                  English, German, and Brasilian Portuguese.
                  <br />
                  <br />I have experience in both research and development of
                  machine learning models. As a CIERA Post-Baccalaureate Fellow
                  at Northwestern University, I researched and developed machine
                  ...
                  evaluation metrics for both classification and object
                  detection problems.
                  <br />
                  <br />
                  ...
                  organizations. My team won a school pitch competition at
                  Denison University and I personally led a small team of
                  business and sales oriented people to acquire 10% of Denison’s
                  student body as users two weeks after launch.
                  <br />
                  <br />
