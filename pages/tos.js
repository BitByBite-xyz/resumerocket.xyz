    ...
    <>
      <main className={styles.main}>
        <Grid.Container gap={1}>
          <Grid xs={12}>
            <Text h3>1. AGREEMENT TO TERMS</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>2. INTELLECTUAL PROPERTY RIGHTS</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>3. USER REPRESENTATIONS</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>4. USER REGISTRATION</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>5. PROHIBITED ACTIVITIES</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
              ...
              <ul>
                ...
                <li>
                  - Reselling cover letters generated on resumerocket.xyz for
                  profit.
                </li>
              </ul>
            </Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>6. USER GENERATED CONTRIBUTIONS</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
              ...
              <ul>
                ...
                <li>
                  - Your Contributions do not include an offensive comments that
                ...
                <li>
                  ...
                  or any applicable law or requlation.
                </li>
              </ul>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>7. CONTRIBUTION LICENSE</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>9. SITE MANAGEMENT</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>10. PRIVACY POLICY</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>11. TERM AND TERMINATION</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>12. MODIFICATIONS AND INTERRUPTIONS</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>14. DISPUTE RESOLUTION</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
              ...
              Cook County, Illinois. Except as otherwise provided herein, the
              ...
              state and federal courts located in Cook County, Illinois, and the
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>17. LIMITATIONS OF LIABILITY</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
              ...
              WILL AT ALL TIMES BE LIMITED TO $50.00 USD. CERTAIN US STATE LAWS
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>18. INDEMNIFICATION</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
          ...
          <Spacer y={2} />
          <Grid xs={12}>
            <Text h3>21. CALIFORNIA USERS AND RESIDENTS</Text>
          </Grid>
          <Grid xs={12}>
            <Text>
